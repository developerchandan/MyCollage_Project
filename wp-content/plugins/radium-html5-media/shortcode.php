...
class Radium_HTML5Media_Shortcode {
	...
	public function audio_sc($atts, $title = null) {
		...
		extract(shortcode_atts( array( 'href' => '', 'poster' => '' ), $atts));

		$html = $this->helper->get_audio( null, $href, $poster );
	...
	public function video_sc($atts, $title = null) {
		...
		extract(shortcode_atts( array( 'href' => '', 'poster' => '', 'height' => ''), $atts ) );

		$html = $this->helper->get_video( null, $href, $poster, $height);
