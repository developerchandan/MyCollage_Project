 ...
 */
class Radium_HTML5Media_Helper {
  ...
  /**
	 ...
	 * @returns string
	 */
	public function get_video( $postid, $video_file_url= null, $poster = null, $height = null ) {
        ...
        //var_export(pathinfo( $video_file_url, PATHINFO_EXTENSION ));

		//$width = get_post_meta($postid, '_radium_video_width', true);
		$height = get_post_meta($postid, '_radium_video_height', true);

		$poster = $poster ? $poster : get_post_meta($postid, '_radium_video_poster', true);
