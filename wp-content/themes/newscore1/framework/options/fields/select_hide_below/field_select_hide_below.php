<?php
class Radium_Options_select_hide_below extends Radium_Options{	
	...
	*/
	function render(){
		...
		echo '<select id="'.$this->field['id'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].']" class="'.$class.' radium-opts-select-hide-below" >';
