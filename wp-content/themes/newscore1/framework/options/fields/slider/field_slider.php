<?php
class Radium_Options_slider extends Radium_Options {
    ...
    */
    ...
    function enqueue() {
        wp_enqueue_script(
            'radium-opts-select-slider-js',
            RADIUM_OPTIONS_URL . 'fields/slider/field_slider.js',
            array('jquery'),
            time(),
            true
        );
