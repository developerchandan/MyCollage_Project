<?php
class Radium_Options_checkbox_hide_below {
    ...
    */
	...
	echo '>';
	echo '<input data-amount="' . $next_to_hide . '" type="checkbox" id="' . $this->field['id'] . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . ']" value="1" class="' . $class . ' radium-opts-checkbox-hide-below" ' . checked($this->value, '1', false) . ' /> ';
