...
<?php if ( bbp_is_anonymous() || ( bbp_is_topic_edit() && bbp_is_topic_anonymous() ) || ( bbp_is_reply_edit() && bbp_is_reply_anonymous() ) ) : ?>
	...
	<fieldset class="bbp-form">
		<legend><?php ( bbp_is_topic_edit() || bbp_is_reply_edit() ) ? _e( 'Author Information', 'radium' ) : _e( 'Your information:', 'radium' ); ?></legend>

		<?php do_action( 'bbp_theme_anonymous_form_extras_top' ); ?>

		<p>
			<label for="bbp_anonymous_author"><?php _e( 'Name (required):', 'radium' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php _e( 'Mail (will not be published) (required):', 'radium' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php _e( 'Website:', 'radium' ); ?></label><br />
