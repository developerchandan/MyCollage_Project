...
<div class="row">
    ...
    <main class="content <?php echo $sidebar['content_class']; ?>"  role="main" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="http://schema.org/Article">
		...
		<form action="" method="post" id="members-directory-form" class="dir-form">
			...
			<h3><?php _e( 'Members Directory', 'radium' ); ?></h3>
			...
			<div class="item-list-tabs" role="navigation">
				<ul>
					<li class="selected" id="members-all"><a href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_members_root_slug() ); ?>"><?php printf( __( 'All Members <span>%s</span>', 'radium' ), bp_get_total_member_count() ); ?></a></li>

					<?php if ( is_user_logged_in() && bp_is_active( 'friends' ) && bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>

						<li id="members-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_friends_slug() . '/my-friends/' ?>"><?php printf( __( 'My Friends <span>%s</span>', 'radium' ), bp_get_total_friend_count( bp_loggedin_user_id() ) ); ?></a></li>
			...
			<div class="item-list-tabs" id="subnav" role="navigation">
				<ul>
					...
					<li id="members-order-select" class="last filter">
						...
						<label for="members-order-by"><?php _e( 'Order By:', 'radium' ); ?></label>
						<select id="members-order-by">
							<option value="active"><?php _e( 'Last Active', 'radium' ); ?></option>
							<option value="newest"><?php _e( 'Newest Registered', 'radium' ); ?></option>
