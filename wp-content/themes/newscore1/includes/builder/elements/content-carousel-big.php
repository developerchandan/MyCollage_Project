<?php
/**
 * Register Carousel Element
 * @return array();
 */
function radium_builder_registar_content_carousel_big_element( $elements ) {
	...
	foreach( $categories as $category )
		$categories_select[$category->cat_ID] = $category->name;
	...
	$element_options = array(
		...
		array(
			...
			'desc'		=> __( 'Minimum of 5 for best results', 'radium' ),
			'std'		=> 16,
			'type'		=> 'text'
		),
		array(
	...
	$elements['content_carousel_big'] = array(
		'info' => array(
			'name' 	=> 'Content Carousel Big',
			'id'	=> 'content_carousel_big',
			'cache'	=> true,
			'desc' 	=> __( 'Sliding content carousel', 'radium' )
		),
...
add_filter('radium_builder_elements', 'radium_builder_registar_content_carousel_big_element');