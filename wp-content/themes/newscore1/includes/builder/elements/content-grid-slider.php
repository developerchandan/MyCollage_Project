 ...
 * @return array();
 */
function radium_builder_registar_content_grid_slider_element( $elements ) {
	...
	$elements['content_grid_slider'] = array(
		'info' => array(
			'name' 	=> 'Content Grid Slider',
			'id'	=> 'content_grid_slider',
            'cache' => true,
			'desc' 	=> __( 'Grid Sliding content', 'radium' )
		),
...
add_filter('radium_builder_elements', 'radium_builder_registar_content_grid_slider_element');