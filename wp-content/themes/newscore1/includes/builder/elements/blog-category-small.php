 ...
 * @return array();
 */
function radium_builder_registar_blog_category_small_element( $elements ) {
	...
	$element_options = array(
		...
		array(
		    'id'        => 'view_all',
		    'name'      => __( 'View all posts in think category link', 'radium'),
		    'desc'      => '',
		    'type'      => 'checkbox'
		),
		...
		array(
		    'id'        => 'view_all_title',
		    'name'      => __( 'View all posts in think category text', 'radium'),
		    'desc'      => '',
		    'std'      => __('VIEW ALL', 'radium'),
		    'type'      => 'text'
		),
	...
	$elements['blog_category_small'] = array(
			'info' => array(
				'name' 	=> __('Blog Category Small', 'radium' ),
				'id'	=> 'blog_category_small',
                'cache' => true, //set to true to cache
				'desc' 	=> __( 'Blog Category Small', 'radium' )
			),
...
add_filter('radium_builder_elements', 'radium_builder_registar_blog_category_small_element');