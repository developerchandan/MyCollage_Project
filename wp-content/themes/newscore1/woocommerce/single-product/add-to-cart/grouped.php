...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt add_to_cart_button product_type_<?php echo $product->product_type; ?>" data-product_id="<?php echo $product->id; ?>" data-product_sku="<?php echo $product->get_sku(); ?>" ><?php echo $product->single_add_to_cart_text(); ?></button>
